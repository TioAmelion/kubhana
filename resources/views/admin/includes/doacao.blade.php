        ...
        <div class="main-section">
            <div class="container">
                <div class="main-section-data">
                    <div class="row row-filtros-doacoes">
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-6">
                            <div class="main-ws-sec">
                                <div class="posts-section post-filtros">
                                ...
                                <div class="posts-section post-doacoes-receber">
                                    @foreach($publicacoes as $dados)
                                        <div class="post-bar">
                                            <div class="post_topbar">
                                                <div class="usy-dt">
                                                    <div class="img-avatar" style="float: left">
                                            ...
                                            @if (Auth::check())
                                                <div class="job-status-bar">
                                                    ...
                                                    @if($dados->tipo_publicacao == "ajuda")
                                                        ...
                                                        <div class="ajudar-feed" style="">
                                                            <img class="gostar" src="assets/images/ajudar-logo.png" alt="" style="width: 20px; float: none; position: relative; top:3px">
                                                            <a href=" {{ route('doacoes-instituicao', ['id' => $dados->id]) }} " style="font-weight: 600; font-size: 18px; color:#000"> Doações {{$dados->doacoes}}</a>
                                                        </div>
